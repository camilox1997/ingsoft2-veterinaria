...
class Mascota{
    ...
    public function registrarMascota($identificacion, $nombre, $apellido, $direccion, $telefono, $username, $pass, $tipo) {
        try {
            
            $this->consulta = "INSERT INTO Mascota() VALUES (:identificacion, :nombre, :apellido, :direccion, :telefono, :username, :pass, :tipo)";
